      ...
      >
        ...
        <div className="grid grid-cols-3 gap-2">
          ...
          <button
            ...
            className="flex items-center justify-center gap-1.5 py-1.5 px-2 bg-neutral-100 hover:bg-neutral-200/80 rounded-xl text-[10px] font-medium text-neutral-800 transition-all active:scale-[0.98]"
        ...
        <div className="mt-3.5 pt-2 flex items-center justify-between text-xs">
          <span className="text-[10px] text-neutral-400">Quick demo:</span>
          <div className="flex items-center gap-1.5">
            <button
              type="button"
              onClick={() => handleQuickDemoFill('personal')}
              className="px-2 py-0.5 rounded-lg bg-neutral-100 hover:bg-neutral-200 text-[10px] text-neutral-700 transition-colors"
            >
              Personal
            </button>
            <button
